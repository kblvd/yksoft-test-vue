<template>
  <div class="container">
    <div class="container__booking">
      <div class="container__title hide">{{ data.title }}</div>
      <div class="container__two-img">
        <img :src="data.image" alt="photo" />
      </div>
      <div class="container__right-content">
        <div class="container__booking-right">
          <div class="container__title">{{ data.title }}</div>
          <div class="container__booking-inputs">
            <input 
              type="text" 
              id="cform-phone" 
          ...
          <div class="container__booking-buttons">
            <BaseButton size="large" variant="blue-filled"
              >Записаться</BaseButton
            >
            <BaseButton size="large" variant="green-filled" hasIcon>
              <template #icon>
                <svg
                  width="24"
                  height="24"
...
export default {
  ...
  setup() {
    ...
    onMounted(() => {
      const phoneInput = document.getElementById("cform-phone");
