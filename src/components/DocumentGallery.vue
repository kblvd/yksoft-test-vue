        ...
        >
          ...
          >
            <a
              ...
              class="document-slider__item"
            >
              <div class="document-slider__item-photo">
  ...
  export default {
    props: {
      ...
      sliderType: {
        type: String,
        default: "mainSlider",
        validator: (value) => ["mainSlider", "documentSlider"].includes(value),
      },
    },
